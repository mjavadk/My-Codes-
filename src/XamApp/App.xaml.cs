...
namespace XamApp
{
    public partial class App : BitApplication
    {
        ...
        protected async override Task OnInitializedAsync()
        {
           ...
           await NavigationService.NavigateAsync("/Verification");
           // await NavigationService.NavigateAsync("/Nav/FinishedSevices");
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry, ContainerBuilder containerBuilder, IServiceCollection services)
        {
            ...
            containerRegistry.RegisterForNav<VerificationView, VerificationViewModel>("Verification");
            containerRegistry.RegisterForNav<FinishedSevicesView, FinishedSevicesViewModel>("FinishedSevices");
